            ...
            <div class="col-md-10 offset-md-1">
               <div class="row">
                  ...
                  <div class="col-xl-5 offset-xl-1 col-md-12 col-sm-12">
                     <p>
                        HEYDER HEDREY CANCHILA DE ANGEL<br>
                        Heidercanchila593@gmail.com<br>
                        Tel. +57 302 279 9571 <br>
                        Valledupar-Cesar 
                     </p>
                  </div>
               </div>
                  ...
                  <div class="col-xl-5 offset-xl-1 col-md-12 col-sm-12">
                     <form action="correo.php" method="post">
                        ...
                        <div class="row">
                           <div class="col-md-12">
                              <div class="md-form form-group">
                                 <input type="text" class="form-control" name="asunto" placeholder="asunto"id="asunto">
                              </div>
                           </div>
                        </div>
                        <div class="row">
                           <div class="col-md-12">
                              <div class="md-form form-group">
                                 <textarea rows="10" cols="50" class="form-control" name="mensaje" placeholder="Su mensaje" id="mensaje"></textarea>
                              </div>
                           </div>
                        </div>
                        <button type="submit" class="btn btn-primary btn-md" id="success" >Enviar</button>
                     </form>
                  </div>
               </div>
            </div>
